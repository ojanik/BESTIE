...
if __name__=="__main__":
    ...
    parser.add_argument('--make_2D_scatter_galactic',action='store_true',help="Flag if 2D scatter plot with the colors corresponding to the bin should be created")
    ...
    parser.add_argument('--galactic',action='store_true',help="Flag if galactic component is included")
    ...
    plot_routine(model_path=args.model_path,
         ...
         make_2D_scatter_galactic=args.make_2D_scatter_galactic,
