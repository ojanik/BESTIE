...
class NNMFit_handler():
    ...
    def __init__(self,config):
        ...
        self.name_keys = [key for key in config_dict["config"].keys() if "baseline_dataset" in config_dict["config"][key].keys()]
    ...
    def _set_weight_graph(self):
        ...
        self._weight_graph = Graph.w_tensor[self.name_keys[0]]
